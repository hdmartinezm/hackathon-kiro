...
- [ ] Publicar links importantes en #anuncios

## Verificación Final
- [ ] Todos tienen acceso a GitHub
- [ ] Todos tienen acceso a Trello
- [ ] Todos tienen acceso a Drive
- [ ] Todos están en Discord/Slack
- [ ] AWS verificado: `aws sts get-caller-identity --profile Sandbox-Hackathon`
- [ ] Cada miembro probó: clone + install + run
